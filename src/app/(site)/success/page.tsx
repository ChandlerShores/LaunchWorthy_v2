...
export default function SuccessPage() {
  ...
  return (
    <>
      {/* Success Hero */}
      <Section padding="xl" className="bg-gradient-to-br from-success-50 to-white">
        <div className="text-center max-w-4xl mx-auto">
          ...
          {paymentDetails && (
            <div className="bg-white rounded-lg shadow-lg border border-navy-200 p-6 mb-8 max-w-md mx-auto">
              <h2 className="text-lg font-semibold text-navy-900 mb-4">Payment Details</h2>
          ...
          {searchParams.get('booking_completed') === 'true' ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-navy-900 mb-2">Confirmation Email</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-navy-900 mb-2">Session Confirmed</h3>
                <p className="text-gray-600">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-navy-900 mb-2">Prepare for Success</h3>
                <p className="text-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-navy-900 mb-2">Schedule Your Session</h3>
                <p className="text-gray-600">
