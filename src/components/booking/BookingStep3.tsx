    ...
    <div className="space-y-8">
      ...
      <div className="bg-primary-50 border border-primary-200 rounded-lg p-6">
        <div className="flex items-start">
          <Icon name="check" className="w-6 h-6 text-primary-600 mt-0.5 mr-3 flex-shrink-0" />
          <div>
            <h3 className="font-semibold text-primary-900 text-lg">Payment Confirmed</h3>
        ...
        {!hasAllFields && prefilledFields.length > 0 && (
          <div className="bg-sky-50 border border-sky-200 rounded-lg p-4 mb-6">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-semibold text-sky-900">Information Pre-filled</h4>
          ...
          <div className="bg-error-50 border border-error-200 rounded-lg p-4 mb-6">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h4 className="font-semibold text-error-900">Calendly Integration Issue</h4>
                <p className="text-error-800 text-sm mt-1">
                  {fallbackMode 
                ...
                {fallbackMode && (
                  <button
                    type="button"
                    onClick={retry}
                    className="mt-2 text-sm text-error-700 hover:text-error-800 underline"
                  >
                    Try again
                  </button>
                )}
        ...
        {calendlyUrl ? (
          ...
          <div className="bg-warning-50 border border-warning-200 rounded-lg p-6">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-semibold text-warning-900">Calendly Not Configured</h4>
        ...
        <div className="space-y-4">
          ...
          {uploadedFiles.length > 0 && (
            <div className="space-y-2">
              <h4 className="font-medium text-navy-900">Uploaded Files:</h4>
              {uploadedFiles.map((file, index) => (
                <div key={index} className="flex items-center justify-between bg-navy-50 rounded-lg p-3">
      ...
      <div className="bg-white rounded-lg border border-navy-200 p-6">
        ...
        <div>
          <label htmlFor="linkedin-url" className="block text-sm font-medium text-navy-700 mb-2">
          ...
          <input
            ...
            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent ${
              linkedinError ? 'border-error-300' : 'border-gray-300'
            }`}
          />
          {linkedinError && (
            <p className="text-error-600 text-sm mt-2">{linkedinError}</p>
          )}
      ...
      <div className="bg-sky-50 border border-sky-200 rounded-lg p-6">
        <h3 className="font-semibold text-sky-900 mb-4">What Happens Next?</h3>
        <div className="space-y-3">
          <div className="flex items-start">
            <div className="w-6 h-6 bg-info-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-3 mt-0.5 flex-shrink-0">
              1
            </div>
            <div>
              <p className="font-medium text-sky-900">Confirmation Email</p>
              <p className="text-sky-800 text-sm">You'll receive a detailed confirmation with session details</p>
            </div>
          </div>
          <div className="flex items-start">
            <div className="w-6 h-6 bg-info-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-3 mt-0.5 flex-shrink-0">
            ...
            <div>
              <p className="font-medium text-sky-900">Preparation Materials</p>
              <p className="text-sky-800 text-sm">We'll send you a preparation checklist and any relevant materials</p>
            </div>
          </div>
          <div className="flex items-start">
            <div className="w-6 h-6 bg-info-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-3 mt-0.5 flex-shrink-0">
            ...
            <div>
              <p className="font-medium text-sky-900">Your Session</p>
              <p className="text-sky-800 text-sm">Join your scheduled session and start transforming your interview skills!</p>
            </div>
          </div>
        </div>
      </div>
